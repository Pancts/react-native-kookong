...
-(void)getBrandListFromNetDataSource:(NSNotification * )notification
{
    ...
    if ([notification.userInfo[@"taskid"] intValue] == 7 && onGetBrandListFromNetDataSourceSuccess != nil) {
    ...
    onGetBrandListFromNetDataSourceError=nil;
    onGetBrandListFromNetDataSourceSuccess=nil;
}
...
-(void)testIRDataByIdDataSource:(NSNotification * )notification
{
    ...
    if ([notification.userInfo[@"taskid"] intValue] == 19 && testIRDataByIdDataSourceSuccess != nil) {
      /* code */
      id jsonObject = [NSJSONSerialization JSONObjectWithData:notification.userInfo[@"data"] options:NSJSONReadingMutableContainers error:nil];
      NSArray *jsonArray = (NSArray *)jsonObject;
      NSLog(@"jsonArray - %@",jsonArray);
    ...
    testIRDataByIdDataSourceError=nil;
    testIRDataByIdDataSourceSuccess=nil;
...
-(void)getAllRemoteIdsDataSource:(NSNotification * )notification
{
    ...
    if ([notification.userInfo[@"taskid"] intValue] == 8 && getAllRemoteIdsDataSourceSuccess != nil) {
    id jsonObject = [NSJSONSerialization JSONObjectWithData:notification.userInfo[@"data"] options:NSJSONReadingMutableContainers error:nil];
      NSArray *jsonArray = (NSArray *)jsonObject;
      NSLog(@"jsonArray - %@",jsonArray);
      NSDictionary *jsonDictionary = [jsonArray objectAtIndex:2];
    ...
    getAllRemoteIdsDataSourceSuccess=nil;
    getAllRemoteIdsDataSourceError=nil;
...
-(void)powerOnDataSource:(NSNotification * )notification
{
    ...
    if ([notification.userInfo[@"taskid"] intValue] == 20 && powerOnDataSourceSuccess != nil) {
      ...
      NSLog(@"%@",array);
      if ([array count] < 3) {
        powerOnDataSourceError(@[array[1]]);
      }
      NSDictionary * dictionary=array[2];
      NSArray * arr=dictionary[@"irDataList"];
      NSDictionary * dictionary2=arr[0];
      if ([dictionary2[@"type"] intValue]==1) {
        NSArray *airConditionData=[[NSArray alloc] init];
        airConditionData=dictionary2[@"keys"];

        NSLog(@"%@",airConditionData[0]);//按键参数
        NSArray *listItems = [airConditionData[0][@"pulse"] componentsSeparatedByString:@","];
        powerOnDataSourceSuccess(@[listItems]);
...
-(void)powerOffDataSource:(NSNotification * )notification
{
    ...
    if ([notification.userInfo[@"taskid"] intValue] == 20 && powerOffDataSourceSuccess != nil) {
      ...
      NSLog(@"%@",array);
      if ([array count] < 3) {
        powerOffDataSourceError(@[array[1]]);
      }
      NSDictionary * dictionary=array[2];
      NSArray * arr=dictionary[@"irDataList"];
      NSDictionary * dictionary2=arr[0];
      if ([dictionary2[@"type"] intValue]==1) {
        ...
        NSLog(@"%@",airConditionData[0]);//按键参数
        NSArray *listItems = [airConditionData[0][@"pulse"] componentsSeparatedByString:@","];
        powerOffDataSourceSuccess(@[listItems]);
